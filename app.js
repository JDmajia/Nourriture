...
app.post('/user_info',routes.doUser_info);
app.get('/login',routes.login);//用户登录
app.post('/login',routes.doLogin);
app.get('/logout',routes.logout);//用户退出
app.get('/admin',routes.admin_login); //Admin
app.get('/share',routes.share); //User's Share
app.get('/zone',routes.zone); //User's Zone
app.get('/update_user_info',routes.update_user_info);
app.post('/update_user_info',routes.doUpdate_user_info);
